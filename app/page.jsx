                ...
                <Card className="w-full max-w-md mx-auto">
                    ...
                    <CardContent>
                        ...
                        <p className="text-sm text-muted-foreground">
                            Please ensure your PostgreSQL database is running and the DATABASE_URL environment variable
                            is correctly
                            set.
                        </p>
                    </CardContent>
                                ...
                                recentTasks.map((task) => (
                                    <div key={task.id} className="flex items-start justify-between">
                                        <div className="flex-1">
                                            ...
                                            <p className="text-sm text-muted-foreground">Assigned
                                                to: {getStaffName(task.staffId)}</p>
                                            {task.dueDate && (
