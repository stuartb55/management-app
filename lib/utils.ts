...
import type {RecurringPattern, Staff} from "./types" // Import Staff type as well
...
// New utility function to get staff's full name
export function getStaffName(staff: Pick<Staff, 'firstName' | 'lastName'> | undefined | null): string {
    if (!staff) {
