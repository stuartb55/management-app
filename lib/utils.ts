...
import type {RecurringPattern, Staff} from "./types";
...
// Corrected utility function to get staff's full name
export function getStaffName(staff: Pick<Staff, 'name'> | undefined | null): string {
    if (!staff || !staff.name) {
...
export function downloadAsJson<T extends object>(data: T, filename: string): void {
